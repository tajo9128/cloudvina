...
export default function ExportButtons({ jobId = null, job = null, className = "" }) {
    ...
    return (
        <div className={`flex items-center gap-2 ${className}`}>
            {/* 1. PDF Report */}
            <button onClick={() => handleExport('pdf')} className="px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all font-bold text-xs flex items-center gap-2 border border-slate-700">
