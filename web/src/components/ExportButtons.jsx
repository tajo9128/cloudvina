...
export default function ExportButtons({ jobId = null, className = "" }) {
    ...
    return (
        <div className={`flex gap-2 ${className}`}>
            ...
            <button
                onClick={() => handleExport('pymol')}
                className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-lg hover:shadow-xl font-semibold text-sm flex items-center gap-2"
                title="Download PyMOL Visualization Script"
            >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
