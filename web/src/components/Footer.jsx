        ...
        <footer className="bg-[#0B1121] text-white font-sans border-t border-slate-800">
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 py-12 border-b border-slate-800/50">
                    ...
                    {/* Links Section (2/3) - Placeholder/Restored simplified structure */}
                    <div className="lg:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-8">
                        <div>
                            <h4 className="text-white font-bold mb-4">Platform</h4>
                            <ul className="space-y-2 text-sm text-slate-400">
                                <li><Link to="/dock/new" className="hover:text-primary-500 transition-colors">Molecular Docking</Link></li>
                ...
                <div className="pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                    {/* Copyright */}
