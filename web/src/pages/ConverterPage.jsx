...
export default function ConverterPage() {
    ...
    return (
        <div className="bg-slate-50 min-h-screen pt-32 pb-20">
            <SEOHelmet
                title="Free SDF/SMILES to PDBQT Converter | Molecular Docking Tool"
                description="Convert SDF, MOL, PDB, and MOL2 files to PDBQT format instantly for AutoDock Vina. Free online tool for researchers and students. Adds polar hydrogens and partial charges."
                keywords="sdf to pdbqt, smiles to pdbqt, pdbqt converter, molecular docking, autodock vina, ligand preparation, zinc15, pubchem, rcsb pdb"
                canonical="https://biodockify.com/tools/converter"
                schema={schemaMarkup}
            />
            {/* Hero Section */}
            ...
            "@type": "WebApplication",
            "name": "SMILES to PDBQT Converter",
            "description": "Free online tool to convert SDF, MOL2, PDB, and SMILES files to PDBQT format for AutoDock Vina molecular docking.",
            ...
            "Automatic Polar Hydrogen Addition",
