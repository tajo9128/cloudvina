            ...
            <section className="pt-32 pb-20 bg-gradient-to-b from-purple-50 to-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <a href="#how-it-works" className="bg-white text-gray-700 px-8 py-4 rounded-xl text-lg font-bold border border-gray-200 hover:border-purple-200 hover:bg-purple-50 transition shadow-sm">
                            Learn More
                        </a>
                    </div>
                </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Powered by AWS Fargate. Run hundreds of docking jobs in parallel without waiting for queues."
                            },
                            {
                                icon: "🔒",
                                title: "Secure & Private",
                                desc: "Your data is encrypted in transit and at rest. We use ephemeral containers that are destroyed after use."
                            },
                            {
                                icon: "💰",
                                title: "Cost Effective",
                                desc: "Pay only for the compute you use. No monthly fees or hidden infrastructure costs."
                            }
                        ].map((feature, i) => (
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-gray-200">
                            ...
                            <Link to="/auth/signup" className="block w-full py-3 px-6 text-center border-2 border-purple-600 text-purple-600 font-bold rounded-xl hover:bg-purple-50 transition">
                                Get Started
                            </Link>
                        </div>
                        ...
                        <div className="bg-purple-600 p-8 rounded-2xl shadow-xl transform scale-105 relative">
                            ...
                            <Link to="/auth/signup" className="block w-full py-3 px-6 text-center bg-white text-purple-600 font-bold rounded-xl hover:bg-gray-100 transition">
                                Start Free Trial
                            </Link>
                        </div>
