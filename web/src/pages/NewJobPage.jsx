...
export default function NewJobPage() {
    ...
    // Engine Selection
    const [selectedEngine, setSelectedEngine] = useState('vina') // vina, rdock, gnina, consensus
        ...
        try {
            ...
            const createRes = await fetchWithRetry(`${API_URL}/jobs/submit`, {
                ...
                body: JSON.stringify({
                    ...
                    engine: selectedEngine // Pass selected engine
                })
            })
            ...
            const startRes = await fetchWithRetry(`${API_URL}/jobs/${job_id}/start`, {
                ...
                body: JSON.stringify({
                    ...
                    engine: selectedEngine // Pass engine to start call as well
                })
            })
            ...
            <main className="container mx-auto px-4">
                <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
                    <div className="mb-8 flex justify-between items-center">
                        ...
                        <Link to="/dock/batch" className="px-5 py-2.5 bg-secondary-100 text-secondary-700 font-bold rounded-xl hover:bg-secondary-200 transition-colors flex items-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        {/* Docking Engine Info - Always runs Vina + Gnina */}
                        <div className="mb-8">
                            <label className="block text-sm font-bold text-slate-700 mb-2">
                                Docking Engine
                            </label>
                            <div className="p-6 rounded-xl border-2 border-green-500 bg-gradient-to-r from-green-50 to-blue-50">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="font-bold text-lg text-slate-800">AutoDock Vina + Gnina (AI)</div>
                                        <div className="text-sm text-slate-600">Your job will run on both engines for comprehensive results:</div>
                                        <div className="flex flex-wrap gap-3 mt-2">
                                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                🐢 Vina - Industry Standard
                                            </span>
                                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                                🧠 Gnina - AI Deep Learning
                                            </span>
                                        </div>
                                    </div>
