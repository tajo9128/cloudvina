...
export default function Footer() {
    return (
    return (
        <footer className="bg-white text-slate-900 font-sans border-t border-slate-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a href="https://learn.biodockify.com/courses" className="text-slate-600 hover:text-primary-600 transition-colors text-sm">
                                    Courses
                                </a>
                            </li>
                            <li>
                                <a href="https://learn.biodockify.com/blog" className="text-slate-600 hover:text-primary-600 transition-colors text-sm">
                                    Blog
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/docs" className="text-slate-600 hover:text-primary-600 transition-colors text-sm">
                                    Documentation
                                </Link>
                            </li>
                            <li>
                                <a href="https://www.biodockify.com/pricing" className="text-slate-600 hover:text-primary-600 transition-colors text-sm">
                                    Pricing
                                </a>
                            </li>
                        </ul>
