...
export default function SignupPage2() {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            // Explicitly tagging as 'student' for the learning platform
            const { error, data } = await signUp(email, password, {
                full_name: name,
                platform: 'learn.biodockify.com',
                role: 'student'
            });
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 className="mt-6 text-center text-3xl font-display font-bold text-slate-900">
                    Join BioDockify Learning
                </h2>
                <p className="mt-2 text-center text-sm text-slate-600">
                    Create your dedicated student account for <span className="font-bold text-indigo-600">learn.biodockify.com</span>
                </p>
                <p className="mt-1 text-center text-xs text-slate-400">
                    (Separate from main biodockify.com account)
                </p>
            </div>
                ...
                <div className="bg-white py-8 px-4 shadow-xl sm:rounded-lg sm:px-10 border border-slate-100">
                    ...
                    <form className="space-y-6" onSubmit={handleSignup}>
                        ...
                        <div>
                            ...
                            >
                                {loading ? 'Creating Student ID...' : 'Join Learning Platform'} <ArrowRight className="ml-2 w-4 h-4" />
                            </button>
                        </div>
                    </form>
